        ...
        <RadioGroup defaultValue="" className="space-y-3">
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="0-50"
              id="price1"
              aria-checked={currentPrice === "0-50"}
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="50-100"
              id="price2"
              aria-checked={currentPrice === "50-100"}
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem
              value="100-200"
              id="price3"
              aria-checked={currentPrice === "100-200"}
